...
export default function CFBScoreTicker() {
  ...
  if (loading) {
    return (
      <>
        ...
        <div className="score-ticker fixed top-[52px] lg:top-0 right-0 left-0 lg:left-64 bg-black text-white py-2 px-4 z-10 lg:z-40">
  ...
  return (
    <>
      ...
      <div className="score-ticker fixed top-[52px] lg:top-0 right-0 left-0 lg:left-64 bg-black text-white z-10 lg:z-40">
