...
const CONFERENCE_STYLES: Record<string, { color: string; display: string }> = {
  ...
  'Sun Belt': { color: 'bg-green-100 text-green-800', display: 'Sun Belt' },
  'MAC': { color: 'bg-teal-100 text-teal-800', display: 'MAC' },
  'CUSA': { color: 'bg-indigo-100 text-indigo-800', display: 'C-USA' },
  ...
  'OVC-Big South': { color: 'bg-violet-100 text-violet-800', display: 'OVC-Big South' },
